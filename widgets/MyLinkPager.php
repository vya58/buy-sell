 ...
 *
 * В виджете "yii\widgets\ListView" можно присвоить класс лабели активной страницы, но не ссылке внутри его.
 * В разметке же проекта класс "active" присваивается ссылке и CSS при стилизации использует его.
